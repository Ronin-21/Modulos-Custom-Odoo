...
class AccountMove(models.Model):
    ...
    def _auc_update_from_invoice(self):
        ...
        Funciona con facturas originadas desde una OC y con facturas directas sin OC.
        """
        for move in self:
            _logger.info(
            ...
            try:
                ...
                _logger.warning(
                    "AUC invoice: _auc_config() no disponible en res.company. Saltando '%s'.",
                    move.name,
                )
                continue
            ...
            for line in move.invoice_line_ids:
                # Saltamos secciones y notas; procesamos 'product' y False.
