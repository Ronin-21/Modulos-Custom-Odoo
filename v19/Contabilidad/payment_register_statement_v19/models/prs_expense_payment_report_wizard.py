...
class PrsExpensePaymentReportWizard(models.TransientModel):
    ...
    def action_open_list(self):
        ...
        try:
            list_view = self.env.ref("payment_register_statement_v19.view_prs_expense_payment_report_list")
            search_view = self.env.ref("payment_register_statement_v19.view_prs_expense_payment_report_search")
    ...
    def action_print_pdf(self):
        ...
        return self.env.ref("payment_register_statement_v19.action_report_prs_expense_payments").report_action(payments, data=data)
