# l10n_ar_multi_payment_withholding_v19

**Versión:** 19.0.1.0.0  
**Autor:** Alderete Informática  
**Licencia:** LGPL-3  
**Dependencias:** `l10n_ar_withholding`, `l10n_latam_check`, `payment_register_statement_v19`
...
- Compatible con el módulo custom `payment_register_statement_v19`.
- En pagos simples y multi-pago propaga automáticamente `prs_statement_id` y `prs_expense_concept_id` cuando corresponde.
- Mantiene la lógica de retenciones separadas, cheques y conciliación conjunta.


- Incluye fix multicompany para resolución de cuenta base de retenciones en árboles padre/hija.
