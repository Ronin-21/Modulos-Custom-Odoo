...
class ResPartner(models.Model):
    ...
    amount_due_accounting = fields.Monetary(
        ...
        store=False,
        help='Sólo facturas/movimientos en cuentas a cobrar (credit - debit).'
    )
    ...
    amount_due = fields.Monetary(
        ...
        compute='_compute_credit_components',
        store=False,
        help='Suma de deuda contable + ventas sin facturar.'
    )
    ...
    def _compute_credit_components(self):
        ...
        for partner in self:
            # En Odoo: `credit` = Total por Cobrar (lo que el cliente te debe);
            # `debit` = Total por Pagar. Para la deuda del cliente: credit - debit.
