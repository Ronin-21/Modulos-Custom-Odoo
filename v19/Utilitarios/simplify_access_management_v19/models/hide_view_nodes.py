...
class hide_view_nodes(models.Model):
    ...
    _description = 'Ocultar nodos de vista'
    ...
    btn_store_model_nodes_ids = fields.Many2many('store.model.nodes', 'btn_hide_view_nodes_store_model_nodes_rel',
                                                 'hide_id', 'store_id', string='Ocultar botón',
    ...
    page_store_model_nodes_ids = fields.Many2many('store.model.nodes', 'page_hide_view_nodes_store_model_nodes_rel',
                                                  'hide_id', 'store_id', string='Ocultar pestaña/página',
    ...
    link_store_model_nodes_ids = fields.Many2many('store.model.nodes', 'link_hide_view_nodes_store_model_nodes_rel',
                                                  'hide_id', 'store_id', string='Ocultar enlace de kanban',
...
class store_model_nodes(models.Model):
    ...
    _description = 'Nodos de modelo almacenados'
    ...
    node_option = fields.Selection([('button', 'Button'), ('page', 'Page'), ('link', 'Link')], string="Node Option",
                                   required=True)
    attribute_name = fields.Char('Nombre del atributo')
    attribute_string = fields.Char('Etiqueta del atributo', required=True, translate=True)
    lang_code = fields.Char("Código de idioma")
    button_type = fields.Selection([('object', 'Objeto'), ('action', 'Acción')], string="Tipo de botón")
    is_smart_button = fields.Boolean('Botón inteligente')
