...
class hide_filters_groups(models.Model):
    ...
    filters_store_model_nodes_ids = fields.Many2many('store.filters.groups',
                                                     ...
                                                     'hide_id', 'store_id', string='Ocultar filtros',
    ...
    groups_store_model_nodes_ids = fields.Many2many('store.filters.groups',
                                                    ...
                                                    'hide_id', 'store_id', string='Ocultar agrupaciones',
...
class store_model_nodes(models.Model):
    ...
    _description = 'Filtros y grupos almacenados'
    _rec_name = 'attribute_string'

    model_id = fields.Many2one('ir.model', string='Model', index=True, ondelete='cascade', required=True)
    node_option = fields.Selection([('filter', 'Filtro'), ('group', 'Groups')], string="Node Option", required=True)
    attribute_name = fields.Char('Nombre del atributo')
    attribute_string = fields.Char('Etiqueta del atributo', required=True)
