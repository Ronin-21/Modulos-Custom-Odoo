...
class PrsMoneyFlowCard(models.Model):
    ...
    def _prs_accredit_card_transfer(self):
        ...
        dst_line = self._prs_card_create_statement_line(dst_journal, net, label, date)
    ...
    def _prs_card_create_statement_line(self, journal, amount, label, date):
    ...
    def _prs_card_book_commission(self, fee_account, transfer_account, amount, label, date, company):
