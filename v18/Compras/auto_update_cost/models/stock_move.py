...
class StockMove(models.Model):
    ...
    def _action_done(self, cancel_backorder=False):
        ...
        # Leer config UNA sola vez (FIX: performance)
        ...
        # Solo movimientos con línea de compra válida y ya confirmados
        moves = self.filtered(
        ...
        for move in moves:
            ...
            # ── Standard ──────────────────────────────────────────────────────
                ...
                if (purchase_line.product_uom and product.uom_id
                        and purchase_line.product_uom != product.uom_id):
                    unit_cost_oc = purchase_line.product_uom._compute_price(
                ...
                for company in target_companies:
                    try:
                        ...
                        if strategy == 'last':
                            ...
                            new_cost = new_avg
                            if company == order.company_id:
                                display_cost = new_avg  # FIX: mostrar el promedio, no el incoming
